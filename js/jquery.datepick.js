...
$.extend(Datepicker.prototype, {
	...
	defaultRenderer: {
		...
		month: '<div class="datepick-month"><div class="datepick-month-header">{monthHeader:MM yyyy年}</div>' +
	...
	_generateMonth: function(target, inst, year, month, renderer, first) {
		...
		monthHeader = $.datepick.formatDate(monthHeader, $.datepick.newDate(year, month, 1), inst.getConfig()); //(first ? this._generateMonthSelection(
